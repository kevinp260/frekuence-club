# Content and legal TODOs

The following owner inputs remain unresolved and block a final production-ready signoff:

- final Albanian and English manifesto copy
- owner-approved complete entry policy
- legal identity and contact details of the website operator for Privacy
- exact host and application access-log fields, purposes, legal basis, recipients, and retention
- official email address and phone number
- venue accessibility details and a contact route for accessibility or policy questions
- transport and parking guidance, if desired
